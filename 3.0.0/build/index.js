...
KISSY.add('kg/checkcode/3.0.0/index',function (S,D,E) {
    var uid = 1,
        regexp = /^[\da-zA-Z]{4,6}$/,
        ...
        dplStyle = '.{{prefixCls}}checkcode-img,.{{prefixCls}}checkcode-audio{width:175px;height:32px;line-height:32px;position:absolute;}'
                 ...
                 + '.{{prefixCls}}audio-state-text{display:block;width:70px;height:30px;padding-left:30px;font-size:12px;color:#999;text-decoration:none;background:url(//img01.taobaocdn.com/tps/i1/T1HVriXnVeXXbjRy2i-21-169.png) no-repeat 10px -93px;z-index:1;position:absolute;cursor:text;}'
                 ...
                 + '.{{prefixCls}}checkcode-refresher{float:left;display:inline;width:32px;height:32px;vertical-align:top;text-indent:-9999em;outline:none;border-right:1px solid #DDD;background:url(//img01.taobaocdn.com/tps/i1/T1HVriXnVeXXbjRy2i-21-169.png) no-repeat 7px -145px;}'
                 + '.{{prefixCls}}checkcode-switcher{float:left;display:inline;width:32px;height:32px;vertical-align:top;text-indent:-9999em;outline:none;background:url(//img01.taobaocdn.com/tps/i1/T1HVriXnVeXXbjRy2i-21-169.png) no-repeat 0 0;}'
    ...
    var CheckCode = function(cfg) {
        ...
        this.apiserver = S.isString(cfg.apiserver) && cfg.apiserver ? cfg.apiserver : '//pin.aliyun.com';
    ...
    S.augment(CheckCode, S.EventTarget, {
        ...
        log: function(msg) {
            ...
            var img = new Image();
            img.src = '//pin.aliyun.com/captchaerror?' + S.param(msg);
        }
    });
